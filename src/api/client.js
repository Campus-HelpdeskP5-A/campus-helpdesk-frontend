...
/**
 * Generic request helper. Attaches the auth token automatically and
...
export async function request(path, { method = 'GET', body, headers, signal } = {}) {
  ...
  // التوكن منتهي أو غير صالح: نمسح الجلسة ونبلّغ AuthContext يرجّع المستخدم لصفحة الـ Login
...
export function mockDelay(result, ms = 350) {
